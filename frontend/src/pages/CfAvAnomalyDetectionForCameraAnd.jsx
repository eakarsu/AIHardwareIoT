...
// Auto-generated page for: AV anomaly detection for camera and microphone-equipped devi

export default function CfAvAnomalyDetectionForCameraAnd() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-av-anomaly-detection-for-camera-and', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>AV anomaly detection for camera and microphone-equipped devi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>AV anomaly detection for camera and microphone-equipped devices.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run AV anomaly detection for camera and microphone-equipped devi'}
        </button>
      </form>
