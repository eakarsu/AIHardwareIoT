...
// Auto-generated page for: No multi-tenant fleet partitioning

export default function GapNoMultiTenantFleetPartitioning() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-multi-tenant-fleet-partitioning', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No multi-tenant fleet partitioning</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No multi-tenant fleet partitioning</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No multi-tenant fleet partitioning'}
        </button>
      </form>
