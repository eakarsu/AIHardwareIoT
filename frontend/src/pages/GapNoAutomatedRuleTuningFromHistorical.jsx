...
// Auto-generated page for: No automated rule-tuning from historical alert false-positiv

export default function GapNoAutomatedRuleTuningFromHistorical() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-automated-rule-tuning-from-historical', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No automated rule-tuning from historical alert false-positiv</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No automated rule-tuning from historical alert false-positives</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No automated rule-tuning from historical alert false-positiv'}
        </button>
      </form>
