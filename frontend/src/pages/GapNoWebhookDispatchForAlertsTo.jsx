...
// Auto-generated page for: No webhook dispatch for alerts to external systems

export default function GapNoWebhookDispatchForAlertsTo() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-webhook-dispatch-for-alerts-to', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No webhook dispatch for alerts to external systems</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No webhook dispatch for alerts to external systems</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No webhook dispatch for alerts to external systems'}
        </button>
      </form>
