...
// Auto-generated page for: Energy efficiency optimizer extending existing energy-adviso

export default function CfEnergyEfficiencyOptimizerExtendingEx() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-energy-efficiency-optimizer-extending-ex', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Energy efficiency optimizer extending existing energy-adviso</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Energy efficiency optimizer extending existing energy-advisor endpoint with carbon scoring.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Energy efficiency optimizer extending existing energy-adviso'}
        </button>
      </form>
