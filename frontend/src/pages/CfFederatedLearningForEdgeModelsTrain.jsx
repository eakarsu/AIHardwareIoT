...
// Auto-generated page for: Federated learning for edge models trained on aggregate devi

export default function CfFederatedLearningForEdgeModelsTrain() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-federated-learning-for-edge-models-train', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Federated learning for edge models trained on aggregate devi</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Federated learning for edge models trained on aggregate device data without raw telemetry leaving the edge.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Federated learning for edge models trained on aggregate devi'}
        </button>
      </form>
