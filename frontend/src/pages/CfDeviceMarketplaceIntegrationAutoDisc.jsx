...
// Auto-generated page for: Device marketplace integration auto-discovering and provisio

export default function CfDeviceMarketplaceIntegrationAutoDisc() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-device-marketplace-integration-auto-disc', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>Device marketplace integration auto-discovering and provisio</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>Device marketplace integration auto-discovering and provisioning new vendor devices.</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run Device marketplace integration auto-discovering and provisio'}
        </button>
      </form>
