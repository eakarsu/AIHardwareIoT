...
// Auto-generated page for: No video/audio anomaly detection for AV-capable devices

export default function GapNoVideoaudioAnomalyDetectionForAv() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-no-videoaudio-anomaly-detection-for-av', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.75rem', marginBottom: '0.5rem' }}>No video/audio anomaly detection for AV-capable devices</h1>
      <p style={{ color: '#666', marginBottom: '1.5rem' }}>No video/audio anomaly detection for AV-capable devices</p>
      <form onSubmit={handleSubmit} style={{ marginBottom: '1.5rem' }}>
        ...
        >
          {loading ? 'Processing...' : 'Run No video/audio anomaly detection for AV-capable devices'}
        </button>
      </form>
